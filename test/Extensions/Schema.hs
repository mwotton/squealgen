...
type Functions = 
  '[ "_lt_q_regex" ::: Function ('[ NotNull (PGvararray (NotNull PGltree)),  NotNull (PGvararray (NotNull PGlquery)) ] :=> 'Returns ( 'Null PGbool) )
   ...
   , "_ltree_consistent" ::: Function ('[ NotNull (PGvararray (NotNull PGltree)),  NotNull PGint2,  NotNull PGoid ] :=> 'Returns ( 'Null PGbool) )
   ...
   , "lca" ::: Function ('[ NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull (PGvararray (NotNull PGltree)),  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree,  NotNull PGltree ] :=> 'Returns ( 'Null PGltree) )
   ...
   , "ltree_consistent" ::: Function ('[ NotNull PGltree,  NotNull PGint2,  NotNull PGoid ] :=> 'Returns ( 'Null PGbool) )
